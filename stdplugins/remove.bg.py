...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit("Background Removed in {} seconds using ReMove.BG API, powered by @whi5tLe_bL0w3R".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @whi5tLe_bL0w3R\n`{}".format(output_file_name.content.decode("UTF-8")))
